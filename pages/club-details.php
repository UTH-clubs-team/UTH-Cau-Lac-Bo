...
<div id="clubDetails" class="section<?php echo ($activeSection === 'clubDetails') ? ' active' : ''; ?>">
    <div class="container">
        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 2rem;">
            <a class="btn btn-secondary" href="?section=clubs">← Quay về danh sách CLB</a>
            <h1 id="clubDetailsTitle" style="margin: 0; color: #1f2937;">Chi Tiết Câu Lạc Bộ</h1>
        </div>
        ...
        <div id="clubDetailsContent">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        <div>
                            <div class="card-title" id="clubDetailName" style="font-size: 2rem; margin-bottom: 0.5rem;">
                                <?php echo $clubDetails ? htmlspecialchars($clubDetails['name']) : 'Chọn một câu lạc bộ'; ?>
                            </div>
                            <div style="display: flex; gap: 1rem; align-items: center;">
                                <?php
                                    ...
                                    $rawCat = $clubDetails['category'] ?? '';
                                    $displayCat = $rawCat ? ($catMap[$rawCat] ?? ucfirst($rawCat)) : '';
                                ?>
                                <span class="badge badge-info" id="clubDetailCategory"><?php echo $clubDetails ? htmlspecialchars($displayCat) : ''; ?></span>
                                <span class="badge badge-success" id="clubDetailMemberCount"><?php echo $clubDetails ? (int)$clubDetails['member_count'] . ' Thành viên' : ''; ?></span>
                            </div>
                        </div>
                        <?php if ($clubDetails): ?>
                ...
                <div class="card-content">
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-bottom: 1.5rem;">
                        <div style="display:flex; align-items:flex-start; gap:1rem;">
                            ...
                            <?php else: ?>
                                <div style="max-width:280px;">
                                    <div style="width:100%; padding:2rem; border-radius:8px; background:#f3f4f6; text-align:center; color:#6b7280; border:1px dashed #e5e7eb;">Chưa có ảnh</div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <p id="clubDetailDescription" style="line-height: 1.6; color: #374151;">
                            <?php echo $clubDetails ? nl2br(htmlspecialchars($clubDetails['description'])) : 'Vui lòng chọn một câu lạc bộ từ danh sách.'; ?>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom: 2rem;">
                <div class="card-header">
                    <div class="card-title">🎯 Hoạt động & Chương trình</div>
                </div>
                <div class="card-content">
                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center;">
                            ...
                            <span class="badge badge-info" id="memberCountBadge"><?php echo $clubDetails ? count($clubMembers) . ' Tổng' : '0 Tổng'; ?></span>
                        </div>
                    </div>
                </div>
                <div class="card-content">
                    <div class="table-container">
                        <table>
                            ...
                            <tbody id="membersTableBody">
                                ...
                                <tr><td colspan="3">Chưa có thành viên.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
